...
export default function RouteError({
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-bg p-6">
      <div className="w-full max-w-md rounded-lg bg-surface p-6 text-center shadow-md ring-1 ring-line">
        <div className="mx-auto mb-4 grid h-11 w-11 place-items-center rounded-full bg-danger-bg text-danger">
